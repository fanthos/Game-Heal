...
{
    public class HelpMenuButtonPackaging : IGameComponent, ISprite
    {
        private SpriteBatch m_spriteBatch;

        private DButton m_nextButton;
        private DButton m_preButton;
        ...
        public HelpMenuButtonPackaging( SpriteBatch spriteBatch )
        {
            m_mateButtonName = "NextButton";
        ...
        public void Load()
        {
            m_nextButton = new DButton( DButton.DButtonState.Foused, "Texture/Menu/Buttons/NextButton", m_spriteBatch, "NextButton" );
            m_preButton = new DButton( DButton.DButtonState.Idle, "Texture/Menu/Buttons/PreButton", m_spriteBatch, "PreButton" );
            ...
            m_buttonList.Add( m_nextButton );
            m_buttonList.Add( m_preButton );
